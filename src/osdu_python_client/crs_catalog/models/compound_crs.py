...
class CompoundCRS:
    """
    Attributes:
        compound_crs_essence (CompoundCRSEssence | Unset):
    ...
    compound_crs_essence: CompoundCRSEssence | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        compound_crs_essence: dict[str, Any] | Unset = UNSET
        if not isinstance(self.compound_crs_essence, Unset):
            compound_crs_essence = self.compound_crs_essence.to_dict()
        ...
        field_dict.update({})
        if compound_crs_essence is not UNSET:
            field_dict["compoundCRSEssence"] = compound_crs_essence
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        _compound_crs_essence = d.pop("compoundCRSEssence", UNSET)
        compound_crs_essence: CompoundCRSEssence | Unset
        if isinstance(_compound_crs_essence, Unset):
            compound_crs_essence = UNSET
        else:
            compound_crs_essence = CompoundCRSEssence.from_dict(_compound_crs_essence)
        ...
        compound_crs = cls(
            compound_crs_essence=compound_crs_essence,
        ...
        compound_crs.additional_properties = d
        return compound_crs
