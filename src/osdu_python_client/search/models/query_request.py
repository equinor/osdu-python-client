...
if TYPE_CHECKING:
    from ..models.query_request_kind import QueryRequestKind
...
class QueryRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if aggregate_by is not UNSET:
            field_dict["aggregateBy"] = aggregate_by
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        kind = QueryRequestKind.from_dict(d.pop("kind"))
        ...
        aggregate_by = d.pop("aggregateBy", UNSET)
