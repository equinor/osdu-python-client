...
T = TypeVar("T", bound="PatchRecordsResponse")


@_attrs_define
class PatchRecordsResponse:
    """
    Attributes:
        record_count (int | Unset):
        record_ids (list[str] | Unset):
        not_found_record_ids (list[str] | Unset):
        failed_record_ids (list[str] | Unset):
    ...
    failed_record_ids: list[str] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        failed_record_ids: list[str] | Unset = UNSET
        if not isinstance(self.failed_record_ids, Unset):
        ...
        if failed_record_ids is not UNSET:
            field_dict["failedRecordIds"] = failed_record_ids
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        failed_record_ids = cast(list[str], d.pop("failedRecordIds", UNSET))

        errors = cast(list[str], d.pop("errors", UNSET))

        patch_records_response = cls(
        ...
        patch_records_response.additional_properties = d
        return patch_records_response
