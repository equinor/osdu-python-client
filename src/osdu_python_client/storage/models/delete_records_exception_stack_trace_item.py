...
T = TypeVar("T", bound="DeleteRecordsExceptionStackTraceItem")


@_attrs_define
class DeleteRecordsExceptionStackTraceItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_records_exception_stack_trace_item = cls(
        ...
        delete_records_exception_stack_trace_item.additional_properties = d
        return delete_records_exception_stack_trace_item
