...
from ..models.workflow_run_response_status import WorkflowRunResponseStatus
...
class WorkflowRunResponse:
    ...
    Attributes:
        ...
        status (WorkflowRunResponseStatus | Unset): Task execution status
    ...
    status: WorkflowRunResponseStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status: WorkflowRunResponseStatus | Unset
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = WorkflowRunResponseStatus(_status)
