...
) -> AppError | CatalogAttributes | None:
    if response.status_code == 200:
        response_200 = CatalogAttributes.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AppError | CatalogAttributes]:
    return Response(
