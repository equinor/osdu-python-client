...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v2/unit/symbol/{namespaces}/{symbol}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get a unique Unit by Namespace,Symbol
     ...
     'Get single, unique unit given a namespace or namespace list and a symbol. Example:
    namespace=''LIS,RP66,ECL'', symbol=''F'' returns the LIS Foot.'
