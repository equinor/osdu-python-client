...
T = TypeVar("T", bound="EarlyBoundCRSResults")


@_attrs_define
class EarlyBoundCRSResults:
    """A response containing a list of early-bound CRSes.
    ...
    Attributes:
        ...
        crses (list[EarlyBoundCRS] | Unset): The EarlyBoundCRS class.
    """

    offset: int | Unset = UNSET
    count: int | Unset = UNSET
    total_count: int | Unset = UNSET
    crses: list[EarlyBoundCRS] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _crses is not UNSET:
            ...
            for crses_item_data in _crses:
                crses_item = EarlyBoundCRS.from_dict(crses_item_data)

                crses.append(crses_item)

        early_bound_crs_results = cls(
            offset=offset,
            count=count,
        ...
        early_bound_crs_results.additional_properties = d
        return early_bound_crs_results
