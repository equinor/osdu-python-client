...
) -> AppError | CompoundCT | None:
    if response.status_code == 200:
        response_200 = CompoundCT.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        data_partition_id (str):
        body (CompoundCTRequest): Request to get one CompoundCT given its 'persistableReference'
