...
) -> AppError | SingleCT | None:
    if response.status_code == 200:
        response_200 = SingleCT.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        data_partition_id (str):
        body (SingleCTRequest): Request to get one SingleCT given its 'persistableReference'
