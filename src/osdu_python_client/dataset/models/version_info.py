...
if TYPE_CHECKING:
    ...
    from ..models.feature_flag_state import FeatureFlagState
...
class VersionInfo:
    ...
    Attributes:
        ...
        feature_flag_states (list[FeatureFlagState] | Unset):
    """
    ...
    feature_flag_states: list[FeatureFlagState] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        feature_flag_states: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.feature_flag_states, Unset):
            feature_flag_states = []
            for feature_flag_states_item_data in self.feature_flag_states:
                feature_flag_states_item = feature_flag_states_item_data.to_dict()
                feature_flag_states.append(feature_flag_states_item)
        ...
        if feature_flag_states is not UNSET:
            field_dict["featureFlagStates"] = feature_flag_states
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _feature_flag_states = d.pop("featureFlagStates", UNSET)
        feature_flag_states: list[FeatureFlagState] | Unset = UNSET
        if _feature_flag_states is not UNSET:
            feature_flag_states = []
            for feature_flag_states_item_data in _feature_flag_states:
                feature_flag_states_item = FeatureFlagState.from_dict(
                    feature_flag_states_item_data
                )
