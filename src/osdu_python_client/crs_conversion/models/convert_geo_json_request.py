...
T = TypeVar("T", bound="ConvertGeoJsonRequest")


@_attrs_define
class ConvertGeoJsonRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        convert_geo_json_request = cls(
            to_crs=to_crs,
            feature_collection=feature_collection,
            to_unit_z=to_unit_z,
        )

        convert_geo_json_request.additional_properties = d
        return convert_geo_json_request
