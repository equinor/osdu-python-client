...
from ...models.convert_points_request_v4 import ConvertPointsRequestV4
...
def sync_detailed(
    *,
    ...
    Args:
        data_partition_id (str):
        body (ConvertPointsRequestV4): Request to convert a set of points from a source CRS to a
            target CRS
