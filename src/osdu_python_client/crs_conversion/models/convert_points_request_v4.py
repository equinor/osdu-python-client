...
T = TypeVar("T", bound="ConvertPointsRequestV4")


@_attrs_define
class ConvertPointsRequestV4:
    ...
    Attributes:
        ...
        transformation (str | Unset): CRS Transform Example: "{"wkt":"GEOGTRAN[\"PSAD_1956_To_WGS_1984_9\",GEOGCS[\"GCS_
            Provisional_S_American_1956\",DATUM[\"D_Provisional_S_American_1956\",SPHEROID[\"International_1924\",6378388.0,
            297.0]],PRIMEM[\"Greenwich\",0.0],UNIT[\"Degree\",0.0174532925199433]],GEOGCS[\"GCS_WGS_1984\",DATUM[\"D_WGS_198
            4\",SPHEROID[\"WGS_1984\",6378137.0,298.257223563]],PRIMEM[\"Greenwich\",0.0],UNIT[\"Degree\",0.0174532925199433
            ]],METHOD[\"Geocentric_Translation\"],PARAMETER[\"X_Axis_Translation\",-
            295.0],PARAMETER[\"Y_Axis_Translation\",173.0],PARAMETER[\"Z_Axis_Translation\",-
            371.0],AUTHORITY[\"EPSG\",1209]]","ver":"PE_10_3_1","name":"PSAD_1956_To_WGS_1984_9","authCode":{"auth":"EPSG","
            code":"1209"},"type":"ST"}".
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        convert_points_request_v4.additional_properties = d
        return convert_points_request_v4
