...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v2/unit/unitsystem/{unit_system_name}".format(
...
def sync_detailed(
    ...
    *,
    ...
    r"""Get a unique Unit for the given Measurement in the named UnitSystem

     'Get a unique unit given a unit system name and a measurement persistable reference string or
    measurement essence Json structure. Example: Unit system: English; measurement essence: {
    \"ancestry\": \"Length\", \"type\": \"UM\" }'
