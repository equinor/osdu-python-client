...
from ...models.coordinate_transformations_query import CoordinateTransformationsQuery
...
def _get_kwargs(
    *,
    body: CoordinateTransformationsQuery | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        data_partition_id (str):
        body (CoordinateTransformationsQuery | Unset): Body for searching on CTs
