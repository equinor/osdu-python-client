...
) -> AppError | EarlyBoundCRS | None:
    if response.status_code == 200:
        response_200 = EarlyBoundCRS.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AppError | EarlyBoundCRS]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        data_partition_id (str):
        body (EarlyBoundCRSRequest): Request to get one EarlyBoundCRS given its
