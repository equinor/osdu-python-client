...
from ...models.coordinate_reference_systems_query import CoordinateReferenceSystemsQuery
...
def _get_kwargs(
    *,
    body: CoordinateReferenceSystemsQuery | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v3/coordinate-reference-system",
    }
...
def sync_detailed(
    *,
    ...
    Args:
        data_partition_id (str):
        body (CoordinateReferenceSystemsQuery | Unset): Body for searching on CRSs
