...
T = TypeVar("T", bound="MultiRecordRequest")


@_attrs_define
class MultiRecordRequest:
    """Record ids
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        multi_record_request = cls(
            records=records,
        )

        multi_record_request.additional_properties = d
        return multi_record_request
