...
T = TypeVar("T", bound="CompoundCTResults")


@_attrs_define
class CompoundCTResults:
    """A response containing a list of compound cartographic transformations.
    ...
    Attributes:
        ...
        cts (list[CompoundCT] | Unset):
    """

    offset: int | Unset = UNSET
    count: int | Unset = UNSET
    total_count: int | Unset = UNSET
    cts: list[CompoundCT] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _cts is not UNSET:
            ...
            for cts_item_data in _cts:
                cts_item = CompoundCT.from_dict(cts_item_data)

                cts.append(cts_item)

        compound_ct_results = cls(
            offset=offset,
            count=count,
        ...
        compound_ct_results.additional_properties = d
        return compound_ct_results
