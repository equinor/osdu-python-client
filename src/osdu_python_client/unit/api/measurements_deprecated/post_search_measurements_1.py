...
def sync_detailed(
    *,
    ...
    """Search Measurements by keyword(s)
     ...
     'Search measurements by keywords. Valid keywords are: ''name'', ''namespace'', ''source'',
    ''ancestry'', ''code'', ''dimensionCode'', ''unitQuantityCode'', ''dimensionAnalysis'', ''state'',
    ''baseMeasurement''.'
