...
T = TypeVar("T", bound="EarlyBoundCRS")
...
class EarlyBoundCRS:
    """
    Attributes:
        early_bound_crs_essence (EarlyBoundCRSEssence | Unset):
    ...
    early_bound_crs_essence: EarlyBoundCRSEssence | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        early_bound_crs_essence: dict[str, Any] | Unset = UNSET
        if not isinstance(self.early_bound_crs_essence, Unset):
            early_bound_crs_essence = self.early_bound_crs_essence.to_dict()
        ...
        field_dict.update({})
        if early_bound_crs_essence is not UNSET:
            field_dict["earlyBoundCRSEssence"] = early_bound_crs_essence
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        _early_bound_crs_essence = d.pop("earlyBoundCRSEssence", UNSET)
        early_bound_crs_essence: EarlyBoundCRSEssence | Unset
        if isinstance(_early_bound_crs_essence, Unset):
            early_bound_crs_essence = UNSET
        else:
            early_bound_crs_essence = EarlyBoundCRSEssence.from_dict(
                _early_bound_crs_essence
            )
        ...
        early_bound_crs = cls(
            early_bound_crs_essence=early_bound_crs_essence,
        ...
        early_bound_crs.additional_properties = d
        return early_bound_crs
