...
T = TypeVar("T", bound="SingleCTResults")


@_attrs_define
class SingleCTResults:
    """A response containing a list of single cartographic transformations.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        single_ct_results.additional_properties = d
        return single_ct_results
