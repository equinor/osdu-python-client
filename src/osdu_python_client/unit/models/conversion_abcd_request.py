...
T = TypeVar("T", bound="ConversionABCDRequest")


@_attrs_define
class ConversionABCDRequest:
    """an Energistics Abcd style unit conversion request. The requested units are either passed as persistable reference
    strings (JSON serialized Unit 'essence') or as Unit essence structure
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conversion_abcd_request.additional_properties = d
        return conversion_abcd_request
