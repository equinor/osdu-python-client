...
T = TypeVar("T", bound="CRSEssenceImpl")


@_attrs_define
class CRSEssenceImpl:
    """Any coordinate reference system essence carrying all possible properties for LateBoundCRSEssence,
    EarlyBoundCRSEssence and CompoundCRSEssence
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        crs_essence_impl.additional_properties = d
        return crs_essence_impl
