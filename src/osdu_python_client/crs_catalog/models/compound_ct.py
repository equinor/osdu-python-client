...
class CompoundCT:
    """
    Attributes:
        cts (list[SingleCT] | Unset):
        compound_ct_essence (CompoundCTEssence | Unset):
    ...
    cts: list[SingleCT] | Unset = UNSET
    compound_ct_essence: CompoundCTEssence | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        compound_ct_essence: dict[str, Any] | Unset = UNSET
        if not isinstance(self.compound_ct_essence, Unset):
            compound_ct_essence = self.compound_ct_essence.to_dict()
        ...
        if cts is not UNSET:
            field_dict["cts"] = cts
        if compound_ct_essence is not UNSET:
            field_dict["compoundCTEssence"] = compound_ct_essence
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _cts is not UNSET:
            ...
            for cts_item_data in _cts:
                cts_item = SingleCT.from_dict(cts_item_data)

                cts.append(cts_item)

        _compound_ct_essence = d.pop("compoundCTEssence", UNSET)
        compound_ct_essence: CompoundCTEssence | Unset
        if isinstance(_compound_ct_essence, Unset):
            compound_ct_essence = UNSET
        else:
            compound_ct_essence = CompoundCTEssence.from_dict(_compound_ct_essence)
        ...
        compound_ct = cls(
            cts=cts,
            compound_ct_essence=compound_ct_essence,
        ...
        compound_ct.additional_properties = d
        return compound_ct
