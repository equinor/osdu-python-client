...
) -> Detail | HTTPValidationError | UserDetailRequestModel | None:
    if response.status_code == 200:
        response_200 = UserDetailRequestModel.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Detail | HTTPValidationError | UserDetailRequestModel]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get User Details Of Another User
     ...
     ## Get user details
    This API is to retrieve user details on another user
    ```
...
def sync(
    ...
    *,
    ...
    Returns:
        Detail | HTTPValidationError | UserDetailRequestModel
    """
