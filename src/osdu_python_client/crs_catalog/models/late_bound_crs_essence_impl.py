...
T = TypeVar("T", bound="LateBoundCRSEssenceImpl")


@_attrs_define
class LateBoundCRSEssenceImpl:
    """Late-bound coordinate reference system, i.e. a CRS without a transformation binding to WGS 84
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        late_bound_crs_essence_impl = cls(
            auth_code=auth_code,
            type_=type_,
            ver=ver,
            name=name,
        ...
        late_bound_crs_essence_impl.additional_properties = d
        return late_bound_crs_essence_impl
